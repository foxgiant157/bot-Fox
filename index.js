	...
	client.on('message-new', async (mek) => {
		try {
			...
			switch(command) {
				...
				case 'meme':
					...
					client.sendMessage(from, buffer, image, {quoted: mek, caption: 'fica de boa dona neide'})
					break
				case 'memeindo':
				...
				case 'porno':
					...
					client.sendMessage(from, buffer, image, {quoted: mek, caption: 'Vai pra igreja com Hzin irmão'})
					break
				case 'dono':
					memein = await kagApi.memeindo()
				...
				case 'loli':
					memein = await kagApi.memeindo()
					buffer = await getBuffer(`https://1.bp.blogspot.com/-voULciGshU0/YALdvW9I3TI/AAAAAAAACAs/KD7r3Xx5HvUw97jOFiW78fzOgPWAMyhsgCLcBGAsYHQ/w396-h640/images.jpeg`)
					client.sendMessage(from, buffer, image, {quoted: mek, caption: 'Loli em homenagem ao IceBoy'})
					break
				case 'hentai':
					memein = await kagApi.memeindo()
					buffer = await getBuffer(`https://1.bp.blogspot.com/-o1tn2B28yxI/YALaVm5uAYI/AAAAAAAACAE/LRnxiH411-874_fNj7YxBcexA21mRGVKQCLcBGAsYHQ/w465-h640/IMG-20210116-WA0026.jpg`)
					client.sendMessage(from, buffer, image, {quoted: mek, caption: 'Cara bate pra 2d 😂'})
					break
				case 'bomdia':
					memein = await kagApi.memeindo()
					buffer = await getBuffer(`https://i.imgur.com/7VL9cFf.jpg`)
					client.sendMessage(from, buffer, image, {quoted: mek, caption: 'Bom dia, acorda pra cuspir❤️'})
					break
				case 'boatarde':
					memein = await kagApi.memeindo()
        ...
        case 'promote':
				...
				case 'welcome':
					if (!isGroup) return reply(mess.only.group)
					if (!isGroupAdmins) return reply(mess.only.admin)
					if (args.length < 1) return reply('ativou a educação')
					if (Number(args[0]) === 1) {
