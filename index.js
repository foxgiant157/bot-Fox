	...
	client.on('chat-update', async (mek) => {
		try {
			...
			switch(command) {
				...
				case 'meme':
					...
					buffer = await getBuffer(`https://1.bp.blogspot.com/-iqCD9Kk_ZVQ/YALc2rdZE6I/AAAAAAAACAk/SG7YFGW4jjcZXmTX8uD65zUp-rGb586dACLcBGAsYHQ/s720/IMG-20210116-WA0029.jpg`)
					client.sendMessage(from, buffer, image, {quoted: mek, caption: '.......'})
					break
				case 'porno':
					memein = await kagApi.memeindo()
					buffer = await getBuffer(`https://1.bp.blogspot.com/-YD-4s17zGjA/YALaAez-foI/AAAAAAAAB_4/8q-LncQXInYkg6G92YLFMK5rpBxub0MXgCLcBGAsYHQ/s1280/IMG-20210116-WA0027.jpg`)
					client.sendMessage(from, buffer, image, {quoted: mek, caption: 'Vai pra igreja com Hzin'})
					break
				case 'dono':
					memein = await kagApi.memeindo()
					buffer = await getBuffer(`http://2.bp.blogspot.com/_asjRSZVrx3c/TKz8fwlmnXI/AAAAAAAAAb4/ai8y8ENSnPo/s1600/raposa-by-oliveira_leandro.jpg`)
					client.sendMessage(from, buffer, image, {quoted: mek, caption: '*WPP:* wa.me/5527999343206\n*INSTA:* foxgg.av\n\n\n*'})
					break
				case 'belle2':
					memein = await kagApi.memeindo()
				...
				case 'loli1':
					memein = await kagApi.memeindo()
					buffer = await getBuffer(`https://1.bp.blogspot.com/-voULciGshU0/YALdvW9I3TI/AAAAAAAACAs/KD7r3Xx5HvUw97jOFiW78fzOgPWAMyhsgCLcBGAsYHQ/s703/images.jpeg`)
					client.sendMessage(from, buffer, image, {quoted: mek, caption: 'Zero Two em homenagem ao IceBoy'})
					break
				case 'hentai':
					memein = await kagApi.memeindo()
					buffer = await getBuffer(`https://1.bp.blogspot.com/-xcN4EhzQjIU/YALeegLnfVI/AAAAAAAACA4/0coLOI2jik84yfEee0Fi2CrxJzvrqfbwACLcBGAsYHQ/s649/images%2B%25281%2529.jpeg`)
					client.sendMessage(from, buffer, image, {quoted: mek, caption: 'Ce gosta né'})
					break
				case 'bomdia':
					memein = await kagApi.memeindo()
					buffer = await getBuffer(`https://1.bp.blogspot.com/-7Dl06RhdsKM/YALaIOaI7gI/AAAAAAAAB_8/0XNQtSZMBPIN7Pn9aBZUyIWvhDB6zxQ6QCLcBGAsYHQ/s1280/IMG-20210116-WA0028.jpg`)
					client.sendMessage(from, buffer, image, {quoted: mek, caption: 'Bom dia, acorda pra cheriar um pó e comer um churrasco❤️'})
					break
				case 'boatarde':
					memein = await kagApi.memeindo()
					buffer = await getBuffer(`https://i.imgur.com/JaO3yoV.jpg`)
					client.sendMessage(from, buffer, image, {quoted: mek, caption: 'Boa tarde, ademiro ama vcs😎👍'})
					break
				case 'boanoite':
					memein = await kagApi.memeindo()
					buffer = await getBuffer(`https://i.imgur.com/yOFxSUR.jpg`)
					client.sendMessage(from, buffer, image, {quoted: mek, caption: 'Boa noite fml la tropinha❤️'})
					break
				case 'belle':
					memein = await kagApi.memeindo()
				...
				case 'memeindo':
					memein = await kagApi.memeindo()
					buffer = await getBuffer(`https://i.imgur.com/idryv2P.jpeg`)
					client.sendMessage(from, buffer, image, {quoted: mek, caption: '.......'})
					break
				case 'setprefix':
					...
					break
				case 'loli':
                                        if (!isLoli) return reply('❌ *FALSE* ❌')
					loli.getSFWLoli(async (err, res) => {
						if (err) return reply('❌ *ERROR* ❌')
						buffer = await getBuffer(res.url)
						client.sendMessage(from, buffer, image, {quoted: mek, caption: 'pUNHETEIRO SAFADO'})
					})
					break
				case 'nsfwloli':
				...
				case 'limpar':
					...
					break
				case 'ts':
					if (!isOwner) return reply('DÁ ATENÇÃO PRO CARENTE TROPA')
        ...
        case 'promote':
				...
				case 'add':
					...
					if (!isGroupAdmins) return reply(mess.only.admin)
					if (!isBotGroupAdmins) return reply(mess.only.Badmin)
					if (args.length < 1) return reply('CE QUER ADICIONAR TEU PAI?')
